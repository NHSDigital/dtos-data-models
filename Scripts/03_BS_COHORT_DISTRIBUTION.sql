CREATE TABLE BS_COHORT_DISTRIBUTION (
   BS_COHORT_DISTRIBUTION_ID BIGINT               NOT NULL,
   ...
   BS_SELECT_REQUEST_ID UNIQUEIDENTIFIER     NULL,
   CONSTRAINT PK_BS_COHORT_DISTRIBUTION PRIMARY KEY (BS_COHORT_DISTRIBUTION_ID)
);
